  ...
  return (
    <>
      <div className="flex justify-center items-center w-screen h-[20vh]">
        <h1 className="text-white font-bold text-2xl">Lista supermercado</h1>
      </div>
      ...
      <div className="w-screen h-auto ">
        ...
        <div className="max-w-[780px] w-full h-auto flex items-center justify-center gap-2 mx-auto mt-[-20px]">
          ...
          <input
            ...
            className="rounded px-2 py-3 w-24 text-center"
          ...
          <input
            ...
            placeholder="0"
            className="rounded px-2 py-3 w-20 text-center"
          ...
          />
          <button
            className="px-2 py-3 text-white bg-purple-100 rounded disabled:cursor-not-allowed disabled:bg-purple-300 disabled:text-gray-500"
            onClick={addItems}
            disabled={!formState.amount || !formState.title || !formState.price}
          >
            adicionar
          </button>
        </div>
